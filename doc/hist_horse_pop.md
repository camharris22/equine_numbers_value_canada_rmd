...
The R (R Core Team 2020) programming language and the following R
...
Below we zoom in and look at the province of Saskatchewan:

![](hist_horse_pop_files/figure-gfm/plot%20province-1.png)<!-- -->

Figure 2. Horse populations for Saskatchewan between 1940-1972.
